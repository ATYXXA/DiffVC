...
out_dir = 'es_tts_t2e_lj'
tgt = 'spk0'
tgt_path = '/home/huangf79/projects/Grad-TTS/LJSpeech-1.1/wavs/LJ001-0001.wav'

# out_dir = 'es_tts_t2e_vctk'
# tgt = 'p245'
# tgt_path = '/home/huangf79/projects/DiffVC/dataset/vctk/wavs/p245/p245_003.wav'

# out_dir = 'es_tts_t2e_vctk'
# tgt = 'p270'
# tgt_path = '/home/huangf79/projects/DiffVC/dataset/vctk/wavs/p270/p270_003.wav'
...
def process_one(src_path):
    ...
    target_len = int( unit_source.shape[-1] * scale) # 1.72265625 (22050/256)/(16000/320) 
...
if __name__ == "__main__":
    ...
    print(out_dir)
    with torch.no_grad():
        process_list('/home/huangf79/projects/Grad-TTS/t2eembs/t2e-emb-tgt.txt')
